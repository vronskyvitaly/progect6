// + [выполненно] Сверстать в html две кнопки, через js повесить на них событие в котором по нажатию на кнопку в консоли появляется надпись click 1. Передавать в обработчик для двух кнопок callback функцию 2. Удалить обработчик событий с первой кнопки (закоментить) 3.  сделать так чтобы по нажатию на первую кнопку цвет текста был красного цвета и размер шрифта становился 20 px, а по нажатию на вторую кнопку цвет текста был зелёный (сделать это через атрибуты)
